...
void SetDefaultGains(){
  ...
  /*d.v.kp_pitch_rate = 0.4125;
   ...
   d.v.kp_pitch_attitude = 5.35;
   d.v.ki_pitch_attitude = 1;
   d.v.kd_pitch_attitude = 0.075;
   d.v.fc_pitch_attitude = 75.0;
   
   d.v.kp_roll_attitude = 5.35;
   d.v.ki_roll_attitude = 2;
   d.v.kd_roll_attitude = 0.075;
   d.v.fc_roll_attitude = 75.0;
   
   d.v.kp_yaw_attitude = 3.0;
   d.v.ki_yaw_attitude = 3;
   d.v.kd_yaw_attitude = 0.01;
   d.v.fc_yaw_attitude = 50.0;
   
   d.v.kp_altitude_position = 1.5;
   d.v.ki_altitude_position = 4;
   d.v.kd_altitude_position = 5;
   d.v.fc_altitude_position = 6;
   ...
   d.v.kp_loiter_pos_x = 7;
   d.v.ki_loiter_pos_x = 8;
   d.v.kd_loiter_pos_x = 9;
   d.v.fc_loiter_pos_x = 10;
   
   d.v.kp_loiter_rate_x = 11;
   d.v.ki_loiter_rate_x = 12;
   d.v.kd_loiter_rate_x = 13;
   d.v.fc_loiter_rate_x = 14;
   
   d.v.kp_loiter_pos_y = 15;
   d.v.ki_loiter_pos_y = 16;
   d.v.kd_loiter_pos_y = 17;
   d.v.fc_loiter_pos_y = 18;
   
   d.v.kp_loiter_rate_y = 19;
   d.v.ki_loiter_rate_y = 20;
   d.v.kd_loiter_rate_y = 21;
   d.v.fc_loiter_rate_y = 22;
   
   d.v.kp_waypoint_position = 10;
   d.v.ki_waypoint_position = 23;
   d.v.kd_waypoint_position = 24;
   d.v.fc_waypoint_position = 25;
   
   d.v.kp_waypoint_velocity = 1;
   d.v.ki_waypoint_velocity = 10;
   d.v.kd_waypoint_velocity = 26;
   d.v.fc_waypoint_velocity = 27;
   
   d.v.kp_cross_track = 28;
   d.v.ki_cross_track = 29;
   d.v.kd_cross_track = 30;
   d.v.fc_cross_track = 31;
   
   d.v.declination = 123.321;  */
